    ...
    <div class="section">
        <div class="trai">
            ...
            <a href="xemNguyenLieu.php">Trang chủ</a>
                ...
                <a href="#">Nhập kho</a>
                <a href="#">Xuất kho</a>
                <a href="xemNguyenLieu1.php">Xem nguyên liệu</a>
                <a href="#" style="color: rgb(0, 255, 0);">Thành phẩm</a>
            ...
            <div class="khung">
                <table>
                    <tr>
                        ...
                        if ($action == "xemThanhPham") {
                            $thanhPhamData = $controllerSanPham->xemThanhPham();

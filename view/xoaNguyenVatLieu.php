...
<?php
if (isset($_POST["xoaNguyenVatLieu"])) {
    ...
    if ($SoLuongTon != 0) {
        $sql = "UPDATE  sanpham SET  SoLuongTon = 0 WHERE MaSanPHam = $MaSanPHam ";
        $result = $conn->query($sql);
        header("location: nguyenVatLieu.php");
    } else {
        echo "Không thể cập nhât vì số lượng đã bằng 0! " . mysqli_error($conn);
    }
}
mysqli_close($conn);
                ...
                <div class="content-table thongtin">
                    ...
                    <form class="form" method="POST" action="">
                        ...
                        <div class="btn-Phieu">
                            ...
                            <button class="btn btn-success " name="xoaNguyenVatLieu" value="xoaNguyenVatLieu">Xóa</button>
                        </div>
                    </form>

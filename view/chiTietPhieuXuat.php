...
<body>
    <div class="section">
        ...
        <div class="phai">
            <div class="phanphoi">
                <a href="#">
                    <h3>Đơn yêu cầu > Đơn yêu cầu xuất > Chi tiết</h3>
                </a>
            </div>
            <div class="khung">
                <div class="content-table thongtin">
                    <h3>CHI TIẾT ĐƠN YÊU CẦU XUẤT</h3>
                    <button type="button" class="close" aria-label="Close">
                        <span aria-hidden="true"><a href="phieuXuat.php">&times;</a></span>
                    </button>
                    <form class="form" action="/action_page.php">
                        <div class="form-group">
                            <label for="Thời gian tạo	" class="control-label ">Mã phiếu</label>
                        ...
                        <div class="form-group">
                            <label for="Người lập" class="control-label ">Người lập</label>
                            <input type="text" value="<?php echo $row['MaTaiKhoan']; ?>" class="form-control" disabled>
                        </div>
                        <div class="form-group">
                            <label for="Thời gian tạo	" class="control-label ">Thời gian tạo</label>
